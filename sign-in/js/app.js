(() => {
    ...
    let item = document.querySelector(".page__main-item");
    let rotate = document.querySelector(".form-signin__sign-up");
    let rotateTwo = document.querySelector(".form-signup__login");
    rotate.addEventListener("click", (() => {
        item.classList.add("rotate");
        item.classList.remove("rotate-2");
    }));
    rotateTwo.addEventListener("click", (() => {
        item.classList.add("rotate-2");
